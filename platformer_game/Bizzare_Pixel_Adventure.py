                                 ...
                                 if location == 15:
                                    try:
                                             ...
                                             if hp_boss == 5:
                                                        ...
                                                        ejsk_hp =    Hero_sprite(shar_x,shar_y-dobavka, 'Data/images/decorations/hp bar first boss/hp_bar_5of5.png')
                                                        decoration.add(ejsk_hp)
                                                        na_rasstrel.append(ejsk_hp)
                                             if hp_boss == 4:
                                                        ejsk_hp.kill()
                                                        ejsk_hp =    Hero_sprite(shar_x,shar_y-dobavka, 'Data/images/decorations/hp bar first boss/hp_bar_4of5.png')
                                                        decoration.add(ejsk_hp)
                                                        na_rasstrel.append(ejsk_hp)
                                             if hp_boss == 3:
                                                        ejsk_hp.kill()
                                                        ejsk_hp =    Hero_sprite(shar_x,shar_y-dobavka, 'Data/images/decorations/hp bar first boss/hp_bar_3of5.png')
                                                        decoration.add(ejsk_hp)
                                                        na_rasstrel.append(ejsk_hp)
                                             if hp_boss == 2:
                                                        ejsk_hp.kill()
                                                        ejsk_hp =    Hero_sprite(shar_x,shar_y-dobavka, 'Data/images/decorations/hp bar first boss/hp_bar_2of5.png')
                                                        decoration.add(ejsk_hp)
                                                        na_rasstrel.append(ejsk_hp)
                                             if hp_boss == 1:
                                                        ejsk_hp.kill()
                                                        ejsk_hp =    Hero_sprite(shar_x,shar_y-dobavka, 'Data/images/decorations/hp bar first boss/hp_bar_1of5.png')
                                                        decoration.add(ejsk_hp)
                                                        na_rasstrel.append(ejsk_hp)
                                             if hp_boss == 0:
                                                        ejsk_hp.kill()
                                                        ejsk_hp =    Hero_sprite(shar_x,shar_y-dobavka, 'Data/images/decorations/hp bar first boss/hp_bar_0of5.png')
                                                        decoration.add(ejsk_hp)
                                                        na_rasstrel.append(ejsk_hp)
                                                        try:
                                                            tvar_die.kill()
                                                        ...
                                                        #can_moving = False\
                                                        if die_anim_check == 1:
                                                            first_boss_death.play()
                                                        if die_anim_check < die_anim //11 *1:
                                                            tvar_die =    Hero_sprite(ejsk_hp.rect.x, 570, 'Data/images/first boss/die/dying_left_1.png')
                                                        elif die_anim_check < die_anim //11*3:
                                                            tvar_die =    Hero_sprite(ejsk_hp.rect.x, 570, 'Data/images/first boss/die/dying_left_2.png')
                                                        elif die_anim_check < die_anim //11*5:
                                                            tvar_die =    Hero_sprite(ejsk_hp.rect.x, 570, 'Data/images/first boss/die/dying_left_3.png')
                                                        elif die_anim_check < die_anim //11*7:
                                                            tvar_die =    Hero_sprite(ejsk_hp.rect.x, 570, 'Data/images/first boss/die/dying_left_4.png')
                                                            
                                                        elif die_anim_check < die_anim //11*9:
                                                            tvar_die =    Hero_sprite(ejsk_hp.rect.x, 570, 'Data/images/first boss/die/dying_left_5.png')
                                                        elif die_anim_check < die_anim //11*12:
                                                            tvar_die =    Hero_sprite(ejsk_hp.rect.x, 570, 'Data/images/first boss/die/dying_left_6.png')
                                                        elif die_anim_check < die_anim //11*15:
                                                            tvar_die =    Hero_sprite(ejsk_hp.rect.x, 570, 'Data/images/first boss/die/dying_left_7.png')
                                                        elif die_anim_check < die_anim //11*18:
                                                            tvar_die =    Hero_sprite(ejsk_hp.rect.x, 570, 'Data/images/first boss/die/dying_left_8.png')
                                                        elif die_anim_check < die_anim //11*21:
                                                            tvar_die =    Hero_sprite(ejsk_hp.rect.x, 570, 'Data/images/first boss/die/dying_left_9.png')
                                                        elif die_anim_check < die_anim //11*24:
                                                            tvar_die =    Hero_sprite(ejsk_hp.rect.x, 570, 'Data/images/first boss/die/dying_left_10.png')
                                                        else:
                                                            try:
                                                                ejsk_hp.kill()
                                                            except:
                                                                pass
                                                            tvar_die =    Hero_sprite(ejsk_hp.rect.x, 570, 'Data/images/first boss/die/dying_left_11.png')
                                                            if die_anim_check == die_anim //11 * 30:
                                                                portal = Hero_sprite(1225, 550, 'Data/images/decorations/portal/normal_porta_0%l.png')
                                                                decoration.add(portal)

                                                            elif die_anim_check == die_anim //11 * 35:
                                                                portal.kill()
                                                                portal = Hero_sprite(1225, 550, 'Data/images/decorations/portal/normal_porta_10%l.png')
                                                                decoration.add(portal)
                                                            elif die_anim_check == die_anim //11 * 40:
                                                                portal.kill()
                                                                portal = Hero_sprite(1225, 550, 'Data/images/decorations/portal/normal_porta_20%l.png')
                                                                decoration.add(portal)
                                                            elif die_anim_check == die_anim //11 * 45:
                                                                portal.kill()
                                                                portal = Hero_sprite(1225, 550, 'Data/images/decorations/portal/normal_porta_30%l.png')
                                                                decoration.add(portal)
                                                            elif die_anim_check == die_anim //11 * 50:
                                                                portal.kill()
                                                                portal = Hero_sprite(1225, 550, 'Data/images/decorations/portal/normal_porta_40%l.png')
                                                                decoration.add(portal)
                                                            elif die_anim_check == die_anim //11 * 55:
                                                                portal.kill()
                                                                portal = Hero_sprite(1225, 550, 'Data/images/decorations/portal/normal_porta_50%l.png')
                                                                decoration.add(portal)
                                                            elif die_anim_check == die_anim //11 * 60:
                                                                portal.kill()
                                                                portal = Hero_sprite(1225, 550, 'Data/images/decorations/portal/normal_porta_60%l.png')
                                                                decoration.add(portal)
                                                            elif die_anim_check == die_anim //11 * 65:
                                                                portal.kill()
                                                                portal = Hero_sprite(1225, 550, 'Data/images/decorations/portal/normal_porta_70%l.png')
                                                                decoration.add(portal)
                                                            elif die_anim_check == die_anim //11 * 70:
                                                                portal.kill()
                                                                portal = Hero_sprite(1225, 550, 'Data/images/decorations/portal/normal_porta_80%l.png')
                                                                decoration.add(portal)
                                                            elif die_anim_check == die_anim //11 * 75:
                                                                portal.kill()
                                                                portal = Hero_sprite(1225, 550, 'Data/images/decorations/portal/normal_porta_90%l.png')
                                                                decoration.add(portal)
                                                            elif die_anim_check == die_anim //11 * 80:
                                                                portal.kill()
                                                                portal = Hero_sprite(1225, 550, 'Data/images/decorations/portal/normal_portal.png')
                                                                decoration.add(portal)
                                                                trigers.add(portal)
                                                                na_rasstrel.append(portal)
                                                            elif die_anim_check > die_anim //11 * 85:
                                                                
                                                                if spawn_gregory_check == spawn_gregory //10 * 1:
                                                                    Gregory = Hero_sprite(1225, 577, 'Data/images/characters/Grisha_1_0%.png')
                                                                    decoration.add(Gregory)
                                                                elif spawn_gregory_check == spawn_gregory //10 * 2:
                                                                    Gregory.kill()
                                                                    Gregory = Hero_sprite(1225, 577, 'Data/images/characters/Grisha_1_10%.png')
                                                                    decoration.add(Gregory)
                                                                elif spawn_gregory_check == spawn_gregory //10 * 3:
                                                                    Gregory.kill()
                                                                    Gregory = Hero_sprite(1225, 577, 'Data/images/characters/Grisha_1_20%.png')
                                                                elif spawn_gregory_check == spawn_gregory //10 * 4:
                                                                    Gregory.kill()
                                                                    Gregory = Hero_sprite(1225, 577, 'Data/images/characters/Grisha_1_30%.png')
                                                                    decoration.add(Gregory)
                                                                elif spawn_gregory_check == spawn_gregory //10 * 5:
                                                                    Gregory.kill()
                                                                    Gregory = Hero_sprite(1225, 577, 'Data/images/characters/Grisha_1_40%.png')
                                                                    decoration.add(Gregory)
                                                                elif spawn_gregory_check == spawn_gregory //10 * 6:
                                                                    Gregory.kill()
                                                                    Gregory = Hero_sprite(1225, 577, 'Data/images/characters/Grisha_1_50%.png')
                                                                    decoration.add(Gregory)
                                                                elif spawn_gregory_check == spawn_gregory //10 * 7:
                                                                    Gregory.kill()
                                                                    Gregory = Hero_sprite(1225, 577, 'Data/images/characters/Grisha_1_60%.png')
                                                                    decoration.add(Gregory)
                                                                elif spawn_gregory_check == spawn_gregory //10 * 8:
                                                                    Gregory.kill()
                                                                    Gregory = Hero_sprite(1225, 577, 'Data/images/characters/Grisha_1_70%.png')
                                                                    decoration.add(Gregory)
                                                                elif spawn_gregory_check == spawn_gregory //10 * 9:
                                                                    Gregory.kill()
                                                                    Gregory = Hero_sprite(1225, 577, 'Data/images/characters/Grisha_1_80%.png')
                                                                    decoration.add(Gregory)
                                                                elif spawn_gregory_check == spawn_gregory //10 * 10:
                                                                    Gregory.kill()
                                                                    Gregory = Hero_sprite(1225, 577, 'Data/images/characters/Grisha_1_90%.png')
                                                                    decoration.add(Gregory)
                                                                elif spawn_gregory_check == spawn_gregory //10 * 11:
                                                                    Gregory.kill()
                                                                    Gregory = Hero_sprite(1225, 577, 'Data/images/characters/Grisha_1.png')
                                                                    decoration.add(Gregory)
                                                                if spawn_gregory_check > spawn_gregory // 10 * 25:
                                                                    if Gregory.rect.x > 450:
                                                                        cord_x = Gregory.rect.x +1
                                                                        cord_y = Gregory.rect.y
                                                                        Gregory.kill()
                                                                        if speed_anim_gregory_check < speed_anim_gregory //10 * 1:
                                                                            Gregory = Hero_sprite(cord_x, 577, 'Data/images/characters/Grisha_walk_1.png')
                                                                        elif speed_anim_gregory_check < speed_anim_gregory //10 *2:
                                                                            Gregory = Hero_sprite(cord_x, 577, 'Data/images/characters/Grisha_walk_2.png')
                                                                        elif speed_anim_gregory_check < speed_anim_gregory //10 *3:
                                                                            Gregory = Hero_sprite(cord_x, 577, 'Data/images/characters/Grisha_walk_3.png')
                                                                        else:
                                                                        ...
                                                                        if dialoge_grisha <3000:
                                                                            speed_anim_gregory_check+=1
                                                                            Gregory.kill()
                                                                            Gregory = Hero_sprite(cord_x, 577, 'Data/images/characters/Grisha_1.png')
                                                                            decoration.add(Gregory)
                                                                            na_rasstrel.append(Gregory)
                                                                            can_moving = False

                                                                            dialoge_grisha +=1
                                                                            if dialoge_grisha == 600:
                                                                                text = font.render("На самом деле я удивлён, что ты смог одолеть Эрициуса!", True, (text_color))
                                                                            elif dialoge_grisha == 1200:
                                                                                text = font.render("Теперь наша следующая задача - Крабоид, повелитель подземного царства.", True, (text_color))
                                                                            elif dialoge_grisha == 1800:
                                                                                text = font.render("Это очень серьёзный и умный противник!", True, (text_color))
                                                                            elif dialoge_grisha == 2400:
                                                                                text = font.render("Не будем же терять времени, заходи в портал.", True, (text_color))
                                                                            if dialoge_grisha > 599:
                                                                                place = text.get_rect(center=(700, 200))
                                                                                sc.blit(text_frame.image, text_frame.rect)   
                                                                                sc.blit(Grisha_frame.image, Grisha_frame.rect)
                                                                                sc.blit(text, place)
                                                                            ...
                                                                            if pygame.sprite.spritecollide(sprite_hero_walk_left_2, trigers, False):
                                                                                text = font.render("Для входа в портал нажмите ``Е``", True, (text_color))
                                                                                place = text.get_rect(center=(650, 200))
                                                                                sc.blit(text_frame.image, text_frame.rect)   
                                                                                sc.blit(text, place)
                                                                                if keys[pygame.K_e]:
                                                                ...
                                                                spawn_gregory_check+=1
                                                        na_rasstrel.append(tvar_die)
                                                        decoration.add(tvar_die)
                                        ...
                                        pass
                                    try :
                                         if pygame.sprite.spritecollide(ejsh, attack_hero, False)   :
                                             if bil_udar == 0:
                                                 hp_boss -=1
                                                 bil_udar = 1
                                    ...
                                    try:
                                        if otbivania  == 16:
                                            ...
                                            if shar_y < 400 :#а где то тут место для анимации раскручивания
                                                    ...
                                                    if shar_y >= 400:
                                                        ...
                                                        ejsk_ball.kill()
                                                        shar_y+=5
                                                        ejsk_ball =    Hero_sprite(shar_x,shar_y, 'Data/images/first boss/out of ball/out_of_ball_left_1.png')
                                                        evil.add(ejsk_ball)
                                                        na_rasstrel.append(ejsk_ball)
                                    ...
                                    try :
                                        ...
                                        if boss_ozidanie != 800:
                                            in_ball_check+=1
                                            #сюда добавить раскручивание и усталость ежа  они должны идти поочереди и сделай проверку того что бы эти анимации не шли одновремменно со суручиванием и что бы обычный еж не повлялся из  следущего коментария

                                            if boss_ozidanie  >= 500 and hp_boss>0:
                                                if nahui_vashego_eja == True:
                                                            #in_ball_check = 0
                                                            #in_ball = 500
                                                            #nalichie_eja = 0
                                                            
                                                        if in_ball_check < in_ball // 8:
                                                                ...
                                                                if nalichie_eja != 1:
                                                                        try:
                                                                                ...
                                                                                pass    
                                                                        ejsh  =  Hero_sprite(polojenie_eja_po_x,570, 'Data/images/first boss/turning into a ball/into a ball_left_1.png')
                                                                        evil.add(ejsh)
                                                                        na_rasstrel.append(ejsh )
                                                                        nalichie_eja = 1
                                                        elif in_ball_check < in_ball // 8 *2:
                                                                if nalichie_eja != 2:
                                                                        ejsh.kill()
                                                                        ejsh  =  Hero_sprite(polojenie_eja_po_x,570, 'Data/images/first boss/turning into a ball/into a ball_left_2.png')
                                                                        evil.add(ejsh)
                                                                        na_rasstrel.append(ejsh )
                                                                        nalichie_eja = 2
                                                        elif in_ball_check < in_ball // 8 *3:
                                                                if nalichie_eja != 3:
                                                                        ejsh.kill()    
                                                                        ejsh  =  Hero_sprite(polojenie_eja_po_x,570, 'Data/images/first boss/turning into a ball/into a ball_left_3.png')
                                                                        evil.add(ejsh)
                                                                        na_rasstrel.append(ejsh )
                                                                        nalichie_eja = 3
                                                        elif in_ball_check < in_ball // 8 *4:
                                                                if nalichie_eja != 4:
                                                                        ejsh.kill()
                                                                        ejsh  =  Hero_sprite(polojenie_eja_po_x,570, 'Data/images/first boss/turning into a ball/into a ball_left_4.png')
                                                                        evil.add(ejsh)
                                                                        na_rasstrel.append(ejsh )
                                                                        nalichie_eja = 4    
                                                        elif in_ball_check < in_ball // 8 *5:
                                                                if nalichie_eja != 5:
                                                                        ejsh.kill()
                                                                        ejsh  =  Hero_sprite(polojenie_eja_po_x,570, 'Data/images/first boss/turning into a ball/into a ball_left_5.png')
                                                                        evil.add(ejsh)
                                                                        na_rasstrel.append(ejsh )
                                                                        nalichie_eja = 5    
                                                        elif in_ball_check < in_ball // 8 *6:
                                                                if nalichie_eja != 6:
                                                                        ejsh.kill()
                                                                        ejsh  =  Hero_sprite(polojenie_eja_po_x,570, 'Data/images/first boss/turning into a ball/into a ball_left_6.png')
                                                                        evil.add(ejsh)
                                                                        na_rasstrel.append(ejsh )
                                                                        nalichie_eja = 6     
                                                        elif in_ball_check < in_ball // 8 *7:
                                                                if nalichie_eja != 7:
                                                                        ejsh.kill()
                                                                        ejsh  =  Hero_sprite(polojenie_eja_po_x,570, 'Data/images/first boss/turning into a ball/into a ball_left_7.png')
                                                                        evil.add(ejsh)
                                                                        na_rasstrel.append(ejsh )
                                                                        nalichie_eja = 7      
                                                        elif in_ball_check < in_ball // 8 *8:
                                                                if nalichie_eja != 8:
                                                                        ejsh.kill()
                                                                        ejsh  =  Hero_sprite(polojenie_eja_po_x,570, 'Data/images/first boss/turning into a ball/into a ball_left_8.png')
                                                                        evil.add(ejsh)
                                                                        na_rasstrel.append(ejsh )
                                                                        nalichie_eja = 8
                                                        else:
                                            ...
                                            if boss_ozidanie < 1:
                                                #вот тут надо что бы еж был лишь в начале боя а потом он не появлялся а тупо были анимации
                                                if nahui_vashego_eja  == False:
                                                            try:
                                                                                ejsh.kill()
                                                            except  :
                                                                                pass  
                                                            ejsh  =  Hero_sprite(900,570, 'Data/images/first boss/stand/hedgehog_stand_left_1.png')
                                                            evil.add(ejsh)
                                                            nahui_vashego_eja  = True
                                                            na_rasstrel.append(ejsh)
                                            boss_ozidanie +=1
                                    ...
                                    try:
                                        ...
                                        if shar == 'posol' and otbivania != 16  and jiv == 1:
                                            ...
                                            if shar_sozdan != 1:
                                                move_ball_check +=1
                                                if move_ball_check < move_ball // 3:
                                                    ejsk_ball =    Hero_sprite(shar_x,shar_y, 'Data/images/first boss/moving/fly_left_1.png')
                                                elif move_ball_check < move_ball // 2:
                                                    ejsk_ball =    Hero_sprite(shar_x,shar_y, 'Data/images/first boss/moving/fly_left_2.png')
                                                elif move_ball_check < move_ball // 3:
                                                    ejsk_ball =    Hero_sprite(shar_x,shar_y, 'Data/images/first boss/moving/fly_left_3.png')
                                                else:
                                                    move_ball_check = 0
                                                    ejsk_ball =    Hero_sprite(shar_x,shar_y, 'Data/images/first boss/moving/fly_left_3.png')
                                                evil.add(ejsk_ball)
                                                na_rasstrel.append(ejsk_ball)
                                                shar_sozdan =1# ну и где то здесь анимация кручения|сделано
                                                
                                            if shar_sozdan == 1 :
                                              
                                                
                                                if  pygame.sprite.spritecollide(ejsk_ball, boss_collison, False) :
                                                    
                                                    kuda_letim =random.randrange(1,3)
                                                    napravlenie_eja+=1
                                                    otbivania +=1
                                                        
                                                if kuda_letim == 1:
                                                    if napravlenie_eja %2 ==1:
                                                        shar_y +=5
                                    ...
                                    if progruzka_levela == 1:#2-7
                                        ...
                                        na_rasstrel.append(wall2)
                                        bil_udar = 0
                                        platform = Hero_sprite(70, 470, 'Data/images/walls/pen_platform_right.png')
                                        walle.add(platform)
                                        na_rasstrel.append(platform)
                                        platform1 = Hero_sprite(1240, 470, 'Data/images/walls/pen_platform_left.png')
                                        text_frame = Hero_sprite(700, 200, 'Data/images/walls/frame_loca_2.png')
                                        Grisha_frame = Hero_sprite(250, 200, 'Data/images/characters/Grisha_frame.png')
                                        na_rasstrel.append(Grisha_frame)
                                        na_rasstrel.append(text_frame)
